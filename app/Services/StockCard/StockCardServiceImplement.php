    ...
    public function stockSearch($request)
    {
        ...
        foreach ($stocks as $item) {
            $data[] = array(
                ...
                'cost_price' =>  StockCard::getStockCardPrice($item->id)->cost_price ?? "Bulunamadı",
                'base_cost_price' =>  StockCard::getStockCardPrice($item->id)->base_cost_price ?? "Bulunamadı",
                'sale_price' =>  StockCard::getStockCardPrice($item->id)->sale_price ?? "Bulunamadı",
            );
        }
        return $data;
    }
