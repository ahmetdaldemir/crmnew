                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3" data-repeater-list="group_a">
                                <?php if(isset($invoices)): ?>
                                    <?php $__currentLoopData = $invoices->detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="col-md-4 col-12 mb-md-0 mb-3 ps-md-0">
                                                        ...
                                                        <select name="stock_card_id"
                                                            ...
                                                            <?php $__currentLoopData = $stocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option
                                                                    <?php echo e($item->hasStock($stock->id) ? 'selected' : ''); ?>  value="<?php echo e($stock->id); ?>"><?php echo e($stock->name); ?>

                                                                    - <small> <?php echo e($stock->brand->name); ?></small> - <b>
                                                    ...
                                                    <div class="col-md-3 col-12 mb-md-0 mb-3 ps-md-0">
                                                        ...
                                                        <select name="color_id"
                                                            ...
                                                            <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option
                                                                    <?php echo e($item->hasStock($color->id) ? 'selected' : ''); ?> value="<?php echo e($color->id); ?>"><?php echo e($color->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-4 col-12 mb-md-0 mb-3 ps-md-0">
                                                        ...
                                                        <input minlength="15" maxlength="15" class="form-control"
                                                               name="imei"
                                                               value="<?php echo e($item->imei); ?>"/>
                                                    </div>
                                                    <div class="col-md-2 col-12 mb-md-0 mb-3 ps-md-0"
                                                         style="text-align: center">
                                                        <p class="mb-2 repeater-title">Temikli Cihaz</p>
                                                        <input class="form-check-input" type="checkbox"
                                                               <?php if($item->assigned_device == 1): ?> selected
                                                               <?php endif; ?> name="assigned_device"/>
                                                    </div>
                                                    <div class="col-md-2 col-12 mb-md-0 mb-3 ps-md-0"
                                                         style="text-align: center">
                                                        <p class="mb-2 repeater-title">Temikli Aksesuar</p>
                                                        <input class="form-check-input" type="checkbox"
                                                               <?php if($item->assigned_accessory == 1): ?> selected
                                                               <?php endif; ?> name="assigned_accessory"/>
                                                    </div>
                                                    <div class="col-md-4 col-12 mb-md-0 mb-3 ps-md-0">
                                                        ...
                                                        <select name="reason_id"
                                                            ...
                                                            <?php $__currentLoopData = $reasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option
                                                                    <?php echo e($item->hasReason($reason->id) ? 'selected' : ''); ?> value="<?php echo e($reason->id); ?>"><?php echo e($reason->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end w-px-300 p-3"
                                                            ...
                                                            <div class="row g-3">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label for="taxInput1"
                                                                           class="form-label">Şube</label>
                                                                    <select name="seller_id" id="taxInput1"
                                                                            class="form-select tax-select">
                                                                        <?php $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option
                                                                                <?php echo e($item->hasSeller($reason->id) ? 'selected' : ''); ?> value="<?php echo e($seller->id); ?>"><?php echo e($seller->name); ?></option>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label for="taxInput2"
                                                                           class="form-label">Depo</label>
                                                                    <select name="warehouse_id" id="taxInput2"
                                                                            class="form-select tax-select">
                                                                        <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option
                                                                                <?php echo e($item->hasWarehouse($reason->id) ? 'selected' : ''); ?>  value="<?php echo e($warehouse->id); ?>"><?php echo e($warehouse->name); ?></option>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label for="taxInput1"
                                                                           class="form-label">KDV</label>
                                                                    <select name="tax" id="taxInput1"
                                                                            class="form-select tax-select">
                                                                        <option
                                                                            <?php echo e($item->tax == 0 ? 'selected' : ''); ?>  value="0"
                                                                            selected="">0%
                                                                        </option>
                                                                        <option
                                                                            <?php echo e($item->tax == 1 ? 'selected' : ''); ?>  value="1">
                                                                            1%
                                                                        </option>
                                                                        <option
                                                                            <?php echo e($item->tax == 8 ? 'selected' : ''); ?>  value="8">
                                                                            10%
                                                                        </option>
                                                                        <option
                                                                            <?php echo e($item->tax == 18 ? 'selected' : ''); ?>  value="18">
                                                                            18%
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                        ...
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <select name="seller_id" id="taxInput1"
                                                                    ...
                                                                    <?php $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option
                                                                            value="<?php echo e($seller->id); ?>"><?php echo e($seller->name); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                            <div class="col-md-6">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u529018053/domains/phonehospital.com.tr/public_html/crm/resources/views/module/invoice/form.blade.php ENDPATH**/ ?>