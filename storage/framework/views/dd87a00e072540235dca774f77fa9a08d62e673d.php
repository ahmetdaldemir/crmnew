        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="btn-group demo-inline-spacing float-end">
                    <a href="<?php echo e(route('sale.create')); ?>" class="btn btn-danger float-end">Yeni Fatura Ekle</a>
                </div>
            </div>
                ...
                <table class="table">
                    ...
                    <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a title="Düzenle" href="<?php echo e(route('sale.edit',['id' => $invoice->id])); ?>"  class="btn btn-icon btn-primary">
                                    <span class="bx bx-edit-alt"></span>
                                </a>
                                <a title="Sil" href="<?php echo e(route('sale.delete',['id' => $invoice->id])); ?>" class="btn btn-icon btn-danger">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u529018053/domains/phonehospital.com.tr/public_html/crm/resources/views/module/sale/index.blade.php ENDPATH**/ ?>