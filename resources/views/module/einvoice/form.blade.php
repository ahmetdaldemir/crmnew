                            ...
                            <div class="col-md-6">
                                <dl class="row mb-2">
                                    ...
                                    <dd class="col-sm-6 d-flex justify-content-md-end">
                                        <div class="w-px-150">
                                            <input type="text" class="form-control" value="{{rand(11111111111,99999999999999)}}" name="number" id="invoiceId">
                                        </div>
                                    </dd>
                                    <dt class="col-sm-6 mb-2 mb-sm-0 text-md-end">
                                    ...
                                    <div class="d-flex border rounded position-relative pe-0">
                                        <div class="row w-100 m-0 p-3">
                                            ...
                                            <div class="col-md-1 col-12 mb-md-0 mb-3">
                                                ...
                                                <input type="number" class="form-control invoice-item-qty" name="quantity" value="1"  min="1" max="50">
                                            </div>
