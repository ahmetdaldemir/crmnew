                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <select name="version_id" id="version_id" class="form-control select2" required></select>
                            </div>
                            <div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="warranty" name="warranty"  value="{{$phone->warranty}}" required>
                                </div>
                                <div class="col-md-12">
