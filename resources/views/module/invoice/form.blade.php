                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select name="seller_id" id="taxInput1"
                                                                        ...
                                                                        @foreach($sellers as $seller)
                                                                            <option
                                                                                {{ $item->hasSeller($reason->id) ? 'selected' : '' }} value="{{$seller->id}}">{{$seller->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select name="warehouse_id" id="taxInput2"
                                                                        ...
                                                                        @foreach($warehouses as $warehouse)
                                                                            <option
                                                                                {{ $item->hasWarehouse($reason->id) ? 'selected' : '' }}  value="{{$warehouse->id}}">{{$warehouse->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select name="tax" id="taxInput1"
                                                                            class="form-select tax-select">
                                                                        <option
                                                                            {{ $item->tax == 0 ? 'selected' : '' }}  value="0"
                                                                            selected="">0%
                                                                        </option>
                                                                        <option
                                                                            {{ $item->tax == 1 ? 'selected' : '' }}  value="1">
                                                                            1%
                                                                        </option>
                                                                        <option
                                                                            {{ $item->tax == 8 ? 'selected' : '' }}  value="8">
                                                                            10%
                                                                        </option>
                                                                        <option
                                                                            {{ $item->tax == 18 ? 'selected' : '' }}  value="18">
                                                                            18%
                                                                        </option>
                                                                    </select>
                                                                </div>
